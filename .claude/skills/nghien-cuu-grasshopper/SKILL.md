...
**Ưu tiên hàng đầu, xuyên suốt mọi component: cách dùng component đó để TẠO PATTERN** (hoạ tiết/mẫu
lặp có kiểm soát tham số). Đây là mục tiêu học tập chính của user (xem `CLAUDE.md` mục "Phạm vi
nghiên cứu Grasshopper") — chủ động tìm góc nhìn pattern ngay từ khi bắt đầu nghiên cứu, không chờ
tới mục 6/10 mới nghĩ tới; góc nhìn này chi phối cả cách chọn ví dụ ở mục 10 lẫn cách mô tả ứng dụng
ở mục 6 bên dưới.
