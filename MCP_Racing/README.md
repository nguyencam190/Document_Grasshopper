...
| [`TOPOLOGY_LIEN_TUC_XE.md`](TOPOLOGY_LIEN_TUC_XE.md) | **Luật cứng về topology vỏ xe.** Topology cả xe là MỘT hệ dòng chảy liên tục, không dựng lưới riêng từng mảnh: quy trình 10 bước cho mỗi cặp part kề nhau, sơ đồ đúng/sai từng cặp (cửa–tai xe, capo–kính, nóc–trụ A, vòm bánh–bệ hông, ô đèn…), luật khe panel, bài test dòng chảy, checklist 20 mục. Kèm bản gốc tiếng Anh copy nguyên văn |
| [`VEHICLE_TOPOLOGY_CONTINUITY.md`](VEHICLE_TOPOLOGY_CONTINUITY.md) | **English version** of the topology rule above — same content, dùng khi cần gửi cho người nước ngoài hoặc dán thẳng làm prompt |
